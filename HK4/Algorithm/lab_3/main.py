...
# Таблица функции с количеством узлов N(11).  
def make_table(N=11):
    x = np.linspace(0, 10, N, dtype=int)
    y = [0, 0.496, 0.986, 1.102, 0.972, 0.754, 0.539, 0.364, 0.236, 0.148, 0.091]
    return {'x': x, 'y': y}
...
import from_lab_1
res_newton1 = from_lab_1.approximate_newton(data['x'], data['y'], 3, x1)
res_newton2 = from_lab_1.approximate_newton(data['x'], data['y'], 3, x2)
