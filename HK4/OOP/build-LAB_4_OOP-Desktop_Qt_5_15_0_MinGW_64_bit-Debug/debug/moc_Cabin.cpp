...
QT_MOC_LITERAL(1, 6, 8), // "openDoor"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 13), // "cabinFinished"
QT_MOC_LITERAL(4, 30, 9), // "stopCabin"
QT_MOC_LITERAL(5, 40, 9), // "moveCabin"
QT_MOC_LITERAL(6, 50, 4) // "free"

    },
    "Cabin\0openDoor\0\0cabinFinished\0stopCabin\0"
    "moveCabin\0free"
};
...
void Cabin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->cabinFinished((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 2: _t->cabinFinished((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->stopCabin(); break;
        case 4: _t->moveCabin(); break;
        case 5: _t->free(); break;
        default: ;
        }
        ...
        {
            using _t = void (Cabin::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cabin::openDoor)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Cabin::*)(bool , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cabin::cabinFinished)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Cabin::cabinFinished(bool _t1, int _t2)
{
