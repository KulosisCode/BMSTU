...
QT_MOC_LITERAL(1, 7, 11), // "pressSignal"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 13), // "unpressSignal"
QT_MOC_LITERAL(4, 34, 5), // "press"
QT_MOC_LITERAL(5, 40, 7) // "unpress"

    },
    "Button\0pressSignal\0\0unpressSignal\0"
    "press\0unpress"
};
...
void Button::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pressSignal((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->unpressSignal(); break;
        case 2: _t->press(); break;
        case 3: _t->unpress(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Button::*)(bool , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Button::pressSignal)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Button::unpressSignal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Button::pressSignal(bool _t1, int _t2)
{
