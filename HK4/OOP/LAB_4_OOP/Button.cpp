...
Button::Button(QWidget *parent) : QPushButton(parent)
{
    ...
    QObject::connect(this, SIGNAL(clicked()), this, SLOT(press()));  // clicked là của thư viện
...
void Button::press()
{
    if (this->_status == NOT_ACTIVE)
    {
        ...
        emit pressSignal(true, this->_curFloor);  // gửi signal tới file controller để tạo thêm hàng chờ
    }
}
