...
def steps_go():
    ...
    spectra_1_but.place(x=28, y=206, width=200, height=26)
...
def spectra_1_win(angle_param):
    ...
    coord_lbl = Label(param_win, text="Координаты центра", bg="lightblue", font="AvantGardeC 14", fg='black')
...
def draw_point(ev_x, ev_y, point, click_):
    if len(point):
        ...
        if option.get() == 1:
            ...
            canvas_win.create_oval(x - 2, y - 2, x + 2, y + 2,
                                   outline='grey', fill='lightblue', activeoutline='lightgreen', width=2, tag='dot2')
...
# Подписи функционала
center_lbl = Label(text="Координаты отрезков", bg='lightblue', font="AvantGardeC 14", fg='black')
...
spectra_lbl = Label(text="Построить пучок", bg='lightblue', font="AvantGardeC 14", fg='black')
measure_lbl = Label(text="Сравнить", bg='lightblue', font="AvantGardeC 14", fg='black')
