...
def draw_point(ev_x, ev_y, click_):
    ...
    if option_line.get() == 0:
        ...
        if click_flag == 1:
            ...
            canvas_win.create_oval(x - 2, y - 2, x + 2, y + 2,
                                   outline='lightblue', fill='lightblue', activeoutline='lightgreen', width=2, tag='clipper1')
        if click_flag == 2:
            ...
            canvas_win.create_oval(x - 2, y - 2, x + 2, y + 2,
                                   outline='lightblue', fill='lightblue', activeoutline='lightgreen', width=2, tag='clipper2')
            draw_clipper()
...
def config(event):
    if event.widget == win:
        ...
        # clean all
        bgn.place(x=30 * win_x, y=680 * win_y, width=235 * win_x, height=28 * win_y)
...
clipper1_radio = Radiobutton(variable=option_line, value=1, bg="lightgrey",
                         activebackground="grey", highlightbackground="grey")
