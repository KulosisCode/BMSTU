...
def draw_point(ev_x, ev_y, click_):
    global option_line, line_coords, clipper_coords, is_close_figure, click_flag
    ...
    if option_line.get() == 0:
        if click_flag == 1:
            ...
            canvas_win.create_oval(x - 2, y - 2, x + 2, y + 2,
                                outline='lightgreen', fill='lightgreen', activeoutline='lightblue', width=2, tag='dot1')
        elif click_flag == 2:
            ...
            canvas_win.create_oval(x - 2, y - 2, x + 2, y + 2,
                                outline='lightgreen', fill='lightgreen', activeoutline='lightblue', width=2, tag='dot2')
            draw_line()
        ...
        canvas_win.create_oval(x - 2, y - 2, x + 2, y + 2,
                               outline='lightblue', fill='lightblue', activeoutline='lightgreen', width=2, tag='clipper_dot')
...
def draw_axes():
    ...
    #     canvas_win.create_line(i, s / 2 - 5, i, s / 2 + 5, fill='lightblue', width=2)
    ...
    #     canvas_win.create_line(s / 2 - 5, i, s / 2 + 5, i, fill='lightblue', width=2)
...
# отрезок
line_lbl = Label(text="Координаты отрезка", bg='lightblue', font="AvantGardeC 14", fg='black')
...
point1_radio = Radiobutton(variable=option_line, value=0, bg="lightgrey",
                         activebackground="grey", highlightbackground="grey")


# отсекатель
clipper_lbl = Label(text="Координаты отсекателя", bg='lightblue', font="AvantGardeC 14", fg='black')
...
clipper_radio = Radiobutton(variable=option_line, value=1, bg="lightgrey",
                         activebackground="grey", highlightbackground="grey")
