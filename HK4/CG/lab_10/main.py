...
def main():
    ...
    Label(text = "ЦВЕТ", font = ("Arial", 16, "bold"), bg = "lightblue",
    ...
    Radiobutton(text = "Чёрный", variable = color_var, value = 0,
        font = ("Arial", 16), bg = "lightgrey", fg = "#29293d", anchor = "w").\
    ...
    Label(text = "ФУНКЦИЯ", font = ("Arial", 16, "bold"), bg = "lightblue",
    ...
    Label(text = "ПРЕДЕЛЫ", font = ("Arial", 16, "bold"), bg = "lightblue",
        fg = "white").place(width = 305, height = 25, x = CANVAS_WIDTH + 5, y = 235)

    Label(text = "Ox", font = ("Arial", 16), bg = "lightgrey",
        fg = "#29293d").place(width = 25, height = 25, x = CANVAS_WIDTH + 15, y = 300)

    Label(text = "от\tдо\tшаг", font = ("Arial", 16), bg = "lightgrey",
        fg = "#29293d").place(width = 230, height = 20, x = CANVAS_WIDTH + 60, y = 270)
    ...
    Label(text = "Oz", font = ("Arial", 16), bg = "lightgrey",
        fg = "#29293d").place(width = 25, height = 25, x = CANVAS_WIDTH + 15, y = 340)
    ...
    Label(text = "МАСШТАБИРОВАНИЕ", font = ("Arial", 16, "bold"), bg = "lightblue",
        fg = "white").place(width = 305, height = 25, x = CANVAS_WIDTH + 5, y = 380)

    Label(text = "Коэффициент = ", font = ("Arial", 16), bg = "lightgrey",
        fg = "#29293d").place(width = 160, height = 20, x = CANVAS_WIDTH + 40, y = 420)

    scale_entry = Entry(font = ("Arial", 16))
    scale_entry.place(width = 80, height = 30, x = CANVAS_WIDTH + 200, y = 415)
    
    Button(highlightbackground = "lightblue", highlightthickness = 30, fg = "lightgrey", state = DISABLED).\
        place(width = 268, height = 30,  x = CANVAS_WIDTH + 25, y = 450)

    Button(text = "Масштабировать", font = ("Arial", 16), borderwidth=0,
    ...
    Button(text = "Повернуть", font = ("Arial", 16), borderwidth=0,
        highlightbackground = "#d1d1e0", highlightthickness = 30, fg = "#33334d",
    ...
    Button(text = "Построить", font = ("Arial", 16), borderwidth=0,
    ...
    Button(text = "Очистить экран", font = ("Arial", 16), borderwidth=0,
        highlightbackground = "#b3b3cc", highlightthickness = 30, fg = "#33334d",
