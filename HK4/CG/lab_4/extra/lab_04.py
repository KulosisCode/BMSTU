...
def draw_point(ev_x, ev_y, point, click_):
    if len(point):
        ...
        canvas_win.create_oval(x - 2, y - 2, x + 2, y + 2,
                               outline='grey', fill='lightblue', activeoutline='lightgreen', width=2, tag='dot1')
...
def block_second_radius(opt_figure):
    ...
    if opt_figure == 1:  # окружность
        ry_entry.configure(state=DISABLED)
        start_radius_y_entry.configure(state=DISABLED)
...
def config(event):
    if event.widget == win:
        ...
        # ввод радиуса
        radius_lbl.place(x=33 * win_x, y=240 * win_y, width=235 * win_x, height=24 * win_y)
        rx_lbl.place(x=33 * win_x, y=270 * win_y, width=110 * win_x, height=18 * win_y)
        ry_lbl.place(x=158 * win_x, y=270 * win_y, width=110 * win_x, height=18 * win_y)
        rx_entry.place(x=33 * win_x, y=289 * win_y, width=110 * win_x, height=20 * win_y)
        ry_entry.place(x=158 * win_x, y=289 * win_y, width=110 * win_x, height=20 * win_y)

        # построить
        bld.place(x=33 * win_x, y=320 * win_y, width=235 * win_x, height=25 * win_y)

        # Построить спектр
        spectra_lbl.place(x=33 * win_x, y=375 * win_y, width=235 * win_x, height=24 * win_y)
        count_lbl.place(x=33 * win_x, y=405 * win_y, width=110 * win_x, height=18 * win_y)
        count_entry.place(x=158 * win_x, y=405 * win_y, width=110 * win_x, height=20 * win_y)

        start_radius_lbl.place(x=33 * win_x, y=430 * win_y, width=235 * win_x, height=18 * win_y)
        start_radius_x_entry.place(x=33 * win_x, y=450 * win_y, width=110 * win_x, height=20 * win_y)
        start_radius_y_entry.place(x=158 * win_x, y=450 * win_y, width=110 * win_x, height=20 * win_y)

        end_radius_lbl.place(x=41 * win_x, y=475 * win_y, width=100 * win_x, height=18 * win_y)
        end_radius_x_entry.place(x=41 * win_x, y=495 * win_y, width=100 * win_x, height=20 * win_y)
        end_radio.place(x=8 * win_x, y=478 * win_y)

        step_lbl.place(x=168 * win_x, y=475 * win_y, width=100 * win_x, height=18 * win_y)
        step_entry.place(x=168 * win_x, y=495 * win_y, width=100 * win_x, height=20 * win_y)
        step_radio.place(x=145 * win_x, y=478 * win_y)

        spc.place(x=33 * win_x, y=525 * win_y, width=235 * win_x, height=25 * win_y)

        # цвет фона и отрезка
        clr.place(x=33 * win_x, y=200 * win_y, width=110 * win_x, height=28 * win_y)
        bgc.place(x=157 * win_x, y=200 * win_y, width=110 * win_x, height=28 * win_y)
        ...
        # clean
        bgn.place(x=33 * win_x, y=690 * win_y, width=235 * win_x, height=30 * win_y)
...
# Подписи функционала
center_lbl = Label(text="Центр построения", bg='lightblue', font="AvantGardeC 14", fg='black')
...
method_lbl = Label(text="Алгоритм", bg='lightblue', font="AvantGardeC 14", fg='black')
...
radius_lbl = Label(text="Радиус фигуры", bg='lightblue', font="AvantGardeC 14", fg='black')
...
spectra_lbl = Label(text="Спектр", bg='lightblue', font="AvantGardeC 14", fg='black')
...
menu = Menu(win)
add_menu = Menu(menu)
add_menu.add_command(label='PROGRAM & AUTHOR',
                     command=lambda: messagebox.showinfo('PROGRAM & AUTHOR', TASK + AUTHOR))
add_menu.add_command(label='EXIT', command=exit)
